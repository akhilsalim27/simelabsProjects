...
public class Main {
    ...
    public static String printResult(){
        ...
        String finalStr = "       JAVA was developed by James Gosling at Sun Microsystems Inc in the year 1991, " +
                "later acquired by Oracle Corporation. It is a simple programming language." +
